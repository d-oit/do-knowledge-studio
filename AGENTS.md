...
The canonical skill source is `.agents/skills/`. See the full table below for all available skills. For detailed documentation on skill creation and usage, see [agents-docs/AVAILABLE_SKILLS.md](agents-docs/AVAILABLE_SKILLS.md).
