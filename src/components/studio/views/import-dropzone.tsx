...
export const ImportDropzone = memo(function ImportDropzone({
  ...
  return (
    ...
    >
      <div className="mb-4">
        <h2 className="font-serif text-lg font-semibold text-ink">{t('import.dropzone.title')}</h2>
      ...
      >
        ...
        <h3 className="font-serif text-[15px] font-semibold text-ink">{t('import.dropzone.chooseHeading')}</h3>
        <p className="mt-1 text-[12px] text-ink-mute">
          {t('import.dropzone.acceptsHint')}
        </p>
        <button
        ...
        >
          {t('import.dropzone.chooseButton')}
        </button>
        <input
          ref={fileInputRef}
          type="file"
